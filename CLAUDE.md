...
### Users
面向 AI 时代的超级个体——独立开发者、自由职业者、链上原住民。他们高度自主、技术敏感，习惯在去中心化环境中工作。核心任务是发布/接取协作任务、管理链上声誉、参与 DAO 治理。他们打开 SuperGuild 时，应感受到「这里是我的主场」——归属感、成员身份认同、链上主权。

### Brand Personality
**协作 · 信任 · 透明**

不是冷酷的金融工具，也不是热闹的社交平台。SuperGuild 是一个严肃但有温度的协作基础设施——可信赖、可验证、对等。

### Aesthetic Direction
- **参考气质**：Figma 的交互丰富度 + Linear 的克制暗色调 + 高信息密度
- **色调**：整体朴素克制，主色 `#137fec` 作为点睛，大面积留白或暗色底，避免色彩堆砌
- **互动**：鼓励微动效、hover 反馈、状态过渡，但每个动效必须有功能意义，不炫技
- **信息密度**：高密度布局，mono 字体强调链上数据，用层级而非空旷来组织信息
- **禁区**：绝对不能出现卡通/可爱元素、emoji 装饰、圆润 Web2 SaaS 模板感、过度粒子特效

### Design Principles
1. **归属感优先**：每个界面都应让用户感到「这是我的空间」，而非访客。成员标识、链上身份、个人数据要显著。
2. **克制的丰富**：互动效果丰富但色彩克制。动效服务于信息传达，不是装饰。
3. **信任可见**：链上状态、合约地址、交易哈希要清晰呈现，而非隐藏。透明是设计语言。
4. **工业精度**：1px 线条、mono 字体、精确的间距——每个细节都体现对精度的尊重。
5. **密度不等于混乱**：高信息密度通过层级、分组、微妙的视觉权重实现，不靠堆砌颜色或装饰。
