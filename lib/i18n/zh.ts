...
const zh: TranslationKeys = {
    ...
    quests: {
        ...
        myQuests: '我的任务',
        noOpenQuests: '暂无公开任务',
        noOpenQuestsDesc: '目前没有正在招募冒险者的任务，稍后再来看看或发布一个新任务！',
        budget: '权益池',
        status: '状态',
        id: '任务 ID',
        created: '创建时间',
        ...
        rejectProvider: '拒绝',
        confirmRejectTitle: '拒绝该申请人？',
        confirmRejectBody: '该申请人将收到申请被拒绝的通知。',
        applicationPending: '你的承接申请正在等待发布人审核',
        applicationRejected: '你的承接申请已被拒绝。',
    ...
    council: {
        ...
        stele_tab_active: '链上投票中',
        stele_tab_history: '历史决议',
        stele_no_active: '暂无进行中的投票',
        stele_no_active_desc: '当提案在星火广场达到 1% VCP 阈值后，将自动进入链上表决',
        stele_no_history: '暂无历史决议',
        stele_no_history_desc: '已完成的链上投票将记录于此',
        statusActive: '执行中',
        statusDraft: '草案中',
        statusPassed: '已通过',
        statusRejected: '已否决',
        ...
        signing: '签名中…',
        cosign: '附议联署',
        proposalOnChain: '已进入链上表决',
        proposalOnChainDesc: '前往黑曜石刻刀参与投票',
        // 投票面板
        voteEnded: '已结束',
        finalResult: '最终结果：',
        currentProjection: '当前预计：',
        noVotesYet: '暂无投票',
        settling: '结算中…',
        settleProposal: '结算提案',
        alreadyVoted: '已投票 ✓',
        // 创建提案弹窗
        createProposal: '发起提案',
        createProposalFee: '需支付 1 USDC（含 Gas 费）',
        proposalTitleLabel: '提案标题 *',
        proposalTitlePlaceholder: '简洁描述提案目标...',
        proposalBodyLabel: '提案正文 *',
        proposalBodyPlaceholder: '详细说明提案内容、背景、预期影响...',
        attachmentsLabel: '附件 / 补充链接（可选）',
        addAttachment: '添加',
